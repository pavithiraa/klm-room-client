...
export function MyBookings() {
  ...
  useEffect(async () => {
    try {
      setloading(true);
      const data = await (
        await axios.post("https://room-server3.herokuapp.com/api/bookings/getbookingsbyuserid", {
          userid: user._id,
        })
      ).data;
      console.log(data);
  ...
  async function cancelBooking(bookingid, roomid) {
    try {
      setloading(true);
      const result = await (
        await axios.post("https://room-server3.herokuapp.com/api/bookings/cancelbooking", { bookingid, roomid })
      ).data;
      console.log(result);
      setloading(false);
